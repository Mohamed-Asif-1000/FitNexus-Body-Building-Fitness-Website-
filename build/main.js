...
const mobileLinks = mobileMenu === null || mobileMenu === void 0 ? void 0 : mobileMenu.querySelectorAll("a");
if (hamburgerBtn && mobileMenu) {
    ...
    mobileLinks === null || mobileLinks === void 0 ? void 0 : mobileLinks.forEach(link => {
...
function moveReviews() {
    ...
    const cards = Array.from(reviewsContainer.children);
...
startInterval();
reviewsContainer === null || reviewsContainer === void 0 ? void 0 : reviewsContainer.addEventListener("mouseenter", () => clearInterval(reviewInterval));
reviewsContainer === null || reviewsContainer === void 0 ? void 0 : reviewsContainer.addEventListener("mouseleave", startInterval);
window.addEventListener('resize', () => {
    reviewIndex = 0;
    if (reviewsContainer)
        reviewsContainer.style.transform = `translateX(0px)`;
});
// Scroll to Top Button View Code
const scrollToTopButton = document.getElementById("scrollTopBtn");
window.addEventListener("scroll", () => {
    if (window.scrollY > 400) {
        scrollToTopButton === null || scrollToTopButton === void 0 ? void 0 : scrollToTopButton.classList.add("show-btn");
    }
    else {
        scrollToTopButton === null || scrollToTopButton === void 0 ? void 0 : scrollToTopButton.classList.remove("show-btn");
    }
});
scrollToTopButton === null || scrollToTopButton === void 0 ? void 0 : scrollToTopButton.addEventListener("click", () => {
